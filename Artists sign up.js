...
form.addEventListener("submit", (e) => {
    ...
    if (!details[0].value || !details[1].value || !details[2].value || !details[3].value || !details[4].value || !details[5].value || !details[6].value) {
        ...
        let user = {
            ...
            portfolio: details[5].value,
            pricing: details[6].value
